...
void setup() {
  ...
  mxconfig.clkphase = true;    // Default
  //mxconfig.clkphase = false;    // Default
  mxconfig.driver = HUB75_I2S_CFG::FM6126A; // Most common driver, avoids specific IC issues initially
  //mxconfig.driver = HUB75_I2S_CFG::SHIFTREG; // Most common driver, avoids specific IC issues initially
  mxconfig.i2sspeed = HUB75_I2S_CFG::HZ_8M; // Good balance
